...
namespace RRCGBuild
{
    public class StudioFunctions : CircuitBuilder
    {
        public override void CircuitGraph()
        {
            ...
            StudioFunctionsObject studioObject = __VariableDeclaratorExpression<StudioFunctionsObject>("studioObject", () => new StudioFunctionsObject(RecRoomObjectPort.Invalid), (rrcg_setter_value) => studioObject = rrcg_setter_value);
            ...
            (Vector3Port, QuaternionPort) multiReturn = __VariableDeclaratorExpression<(Vector3Port, QuaternionPort)>("multiReturn", () => studioObject.MultiReturn(), (rrcg_setter_value) => multiReturn = rrcg_setter_value);
